...
- [ ] i18n: disenado y planificado 2026-06-14. Ejecutar plan `docs/superpowers/plans/2026-06-14-i18n.md` (15 tareas). Spec: `docs/superpowers/specs/2026-06-14-i18n-design.md`. Ejecucion preferida: subagent-driven (requiere confirmacion explicita para lanzar agentes).
